...
from UI.DataDisplay import Ui_Form as uiDataDisplay
...
class DataDisplayWindow(QWidget, uiDataDisplay):
    ...
    def __init__(self,usertype = None):
        ...
        self.settingWidgetAvailable(usertype)
    ...
    def query_and_show(self, tableName, str):
        ...
        # self.tableWidget_1.setItemDelegateForColumn(19, EmptyDelegate(self))
